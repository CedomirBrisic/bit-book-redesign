...
class MyProfilePage extends React.Component {
    ...
    render() {
        return (
            <main>
                <div className="profileCard center row">
                    <div className="container">
                        <img className='circle  margin5p profileImg' width="20%" src={this.state.avatarUrl} alt="" />
                        <h1>{this.state.name}</h1>
                        <div> <p className="aboutSection">{this.state.aboutShort}</p></div>
                    </div>
                    <div className="row">
                    ...
                    <p className="btn-flat bright-shadow modal-trigger" href="#modal1">Edit Profile</p>
                </div>
                <EditProfilePage onUpdateProfile={this.onUpdateProfile} name={this.state.name} aboutShort={this.state.aboutShort} avatarUrl={this.state.avatarUrl} />
